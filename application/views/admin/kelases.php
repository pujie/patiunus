...
<div class="container">		
	<div class="row-fluid">
		...
		<!-- end of added by puji -->
        	<div class="span12">
	            <div class="headline table-sorting"><h3>Kelas</h3></div>
                <table class="table" id="kelass">
                    <thead>
                        <tr class="info">
                            <th>Judul</th>
                            <th>Aktif</th>
                    ...
                    <?php foreach($objs as $obj){?>
                        <tr class="success">
                            ...
                            <td><a href="<?php echo base_url();?>admin/kelas_edit/<?php echo $obj->id;?>"><img src="<?php echo base_url();?>assets/img/aquarius/ic_edit.png"></a>
                            <a href="<?php echo base_url();?>admin/kelas_remove/<?php echo $obj->id;?>"><img src="<?php echo base_url();?>assets/img/aquarius/ic_delete.png"></a>
                            </td>
                        </tr>
                    <?php }?>
                    </tbody>
