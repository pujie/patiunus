...
<!--=== Content Part ===-->
<div class="container">
<form method='POST' action='<?php echo base_url();?>admin/corak_edit_handler'>
	...
	<div class="row-fluid">
        ...
        <div class="row-fluid margin-bottom-20">
            ...
            <div class="span6">
				...
				<div  id="status"></div>
		    	<div class="span4"><input class="span6 border-radius-none" type="text" placeholder="Gambar artikel" id="img1" name="image" value="<?php echo $obj->img;?>"  />
...
var thisdomain = 'http://wadimor/';
    ...
    initimageupload = function(){
    	...
    	new AjaxUpload(btnUpload, {
    		action: thisdomain+'admin/corak_upload_tmp',
    		name: 'uploadfile',
