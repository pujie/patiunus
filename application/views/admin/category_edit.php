...
<!--=== Content Part ===-->
<div class="container">
<form method='POST' action='<?php echo base_url();?>admin/motive_edit_handler'>
<input type="hidden" name="id" value="<?php echo $obj->id;?>" />
	<div class="row-fluid">
        ...
        <div class="row-fluid margin-bottom-20">
            ...
            <div class="span6">
				<label>Nama</label>
		    	<input class="span6 border-radius-none" type="text" placeholder="Text input" id="name" name="name" value="<?php echo $obj->name;?>"  />                    
				<div class="headline"><h3>Keterangan</h3></div>
				    <textarea class="span12 border-radius-none ckeditor" id="description" name="description" rows="8"><?php echo $obj->description;?></textarea>                        
            </div>

			<!-- Input and Textarea-->
            <div class="span6">
				<div class="span2"><label>Gambar</label></div>
				<div  id="status"></div>
		    	<div class="span4"><input class="span6 border-radius-none" type="text" placeholder="Gambar artikel" id="img1" name="img" value="<?php echo $obj->img;?>"  />
				<input type="button" id="btnupload" value="browse" />
				</div>
            </div>
			<div class="span6">
                <div class="span2">Publish</div>
                <div class="span4">
                <?php echo form_dropdown('active',array("1"=>"Ya","0"=>"Tidak"),$obj->active)?>
                </div>
            </div>
        </div><!--/row-fluid-->
...
var thisdomain = 'http://wadimor/';
    ...
    initimageupload = function(){
    	...
    	new AjaxUpload(btnUpload, {
    		action: thisdomain+'admin/motive_upload_tmp',
    		name: 'uploadfile',
