...
<!--=== Content Part ===-->
<div class="container">
<form method='POST' action='<?php echo base_url();?>admin/corak_handler'>
	<div class="row-fluid">
        ...
        <div class="row-fluid margin-bottom-20">
            ...
            <div class="span6">
				<label>Nama</label>
		    	<input class="span6 border-radius-none" type="text" placeholder="Text input" id="name" name="name" value=""  />                    
				<div class="headline"><h3>Keterangan</h3></div>
				    <textarea class="span12 border-radius-none ckeditor" id="description" name="description" rows="8"></textarea>                        
            </div>
            ...
            <div class="span6">
				...
				<div  id="status"></div>
		    	<div class="span4"><input class="span6 border-radius-none" type="text" placeholder="Gambar artikel" id="img1" name="image" value=""  />
