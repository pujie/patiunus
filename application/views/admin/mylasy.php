...
<html>
    ...
    <ul>
        ...
        <li><img width=20 height=20 data-src="<?php echo base_url();?>assets/categories/<?php echo $obj->image;?>" data-src-retina="<?php echo base_url();?>assets/categories/<?php echo $obj->image;?>" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" /></li>
        <?php }?>
    </ul>
